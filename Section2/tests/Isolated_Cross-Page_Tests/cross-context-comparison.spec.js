...
test.describe("Cross-Context Behavior Comparisons", () => {
  test("Same Context Navigation", async ({ page }) => {
...
test.describe("Shared State Problem Demonstration", () => {
  test("Shared State Problem - SHOULD FAIL", async ({ page }) => {
...
test.describe("Multiple Browser Contexts Simulation", () => {
  test("Demonstrate proper context isolation", async ({ browser }) => {
